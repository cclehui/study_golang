...
func cclehuiTest() {
	todayStartTsStr := time.Now().Format("2006-01-02") + " 00:00:00"

	fmt.Println("tttttt, ", todayStartTsStr)

	todayStartTime, _ := time.Parse("2006-01-02 15:04:05", todayStartTsStr)

	fmt.Println("tttttt, ", todayStartTsStr, todayStartTime)

	lastdayTs := todayStartTime.Unix() - 86400*1

	lastdayTime := time.Unix(lastdayTs, 0)

	fmt.Println(lastdayTime.Format("2006-01-02 15:04:05"))

	fmt.Println(time.Now().Format("2006-01-02 15:04:05"))

	newUserdayStartTime, _ := time.Parse("2006-01-02 15:04:05", time.Now().AddDate(0, 0, -6).Format("2006-01-02")+" 00:00:00")
	fmt.Println(newUserdayStartTime.Format("2006-01-02 15:04:05"))
